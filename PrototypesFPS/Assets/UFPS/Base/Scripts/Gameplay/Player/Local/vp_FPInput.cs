...
public class vp_FPInput : vp_Component
{
	...
	protected virtual void InputRun()
	{
		...
		if (vp_Input.GetButton("Run") || Input.GetAxisRaw("Run") != 0)
	...
	protected virtual void InputJump()
	{
		...
		if (vp_Input.GetButton("Jump") || Input.GetButton("Jump"))
...
//		print (vp_Input.GetAxisRaw("Mouse X") + " " + vp_Input.GetAxisRaw("Mouse Y"));
